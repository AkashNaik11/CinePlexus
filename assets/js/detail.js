...
//returns only trailers and teasers
const filterVideos= function (videoList){
    return videoList.filter(({type, site})=> (type == "Trailer" || "Teaser" && site=="youtube"));
}
    ...
    <figure class="poster-box movie-poster">
        ...
        <div class="detail-box">
            <div class="detail-content">
                ...
                <p class="genre">${getGenres(genres)}</p><br>
        ...
        fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=${api_key}&recommendations?page=1`, andSuggestedMovies);


    });

    const andSuggestedMovies= function({results:movieList}, title){
        ...
        movielistElem.innerHTML=`
            <div class="title-wrapper">
                <h1 class="title large">You May Also Like</h1>
            </div> <br>
